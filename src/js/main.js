...
document.addEventListener('DOMContentLoaded', function() {
      ...
      toggle.addEventListener('click', function() {
          ...
          faqToggles.forEach(otherToggle => {
              if (otherToggle !== this) {
                  ...
                  const otherAnswer = otherToggle.closest('.faq__question').nextElementSibling;
  ...
  if (firstToggle && firstToggle.getAttribute('aria-expanded') === 'true') {
      const firstAnswer = firstToggle.closest('.faq__question').nextElementSibling;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function initCustomSelect() {
    const nativeSelects = document.querySelectorAll('.p-contact__native-select');
    
    nativeSelects.forEach(nativeSelect => {
      const wrapper = nativeSelect.closest('.p-contact__custom-select-wrapper');
      if (!wrapper || wrapper.querySelector('.p-contact__custom-select')) return; // 既に生成済みならスキップ
  ...
  function setupCustomSelectEvents(wrapper, nativeSelect) {
    ...
    const trigger = customSelect.querySelector('.p-contact__custom-select-trigger');
    const textElement = customSelect.querySelector('.p-contact__custom-select-text');
    const options = customSelect.querySelectorAll('.p-contact__custom-select-option');
    ...
    trigger.addEventListener('click', function(e) {
      ...
      // 他のセレクトを閉じる
      document.querySelectorAll('.p-contact__custom-select-wrapper').forEach(w => {
        if (w !== wrapper) {
  ...
  document.addEventListener('click', function() {
    document.querySelectorAll('.p-contact__custom-select-wrapper').forEach(wrapper => {
      wrapper.classList.remove('is-open');
      const customSelect = wrapper.querySelector('.p-contact__custom-select');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (window.location.href.includes('contact-confirm') || 
      window.location.href.includes('confirm')) {
    
    const wrappers = document.querySelectorAll('.p-contact__custom-select-wrapper');
